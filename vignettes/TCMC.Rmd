...
`r Biocpkg("TCMC")` package `r Citep(bib[["TCMC"]])` will be soon available on [Bioconductor](http://bioconductor.org).
...
Example integrated with `r Biocpkg("SummarizedExperiment")` `r Citep(bib[["SummarizedExperiment"]])` with machine learning workflows 
